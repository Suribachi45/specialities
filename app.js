...
specialties.forEach(specialty => {
  app.get(`/${specialty}`, (req, res) => {
    ...
    res.send(generateHTML(specialty, filteredUsers));
  });
});

// Ruta principal
app.get('/', (req, res) => {
  res.send('<h1>Bienvenido</h1><p>Selecciona una especialidad:</p><ul><li><a href="/marketing">Marketing</a></li><li><a href="/developers">Developers</a></li><li><a href="/QAs">QAs</a></li><li><a href="/ventas">Ventas</a></li></ul>');
});
